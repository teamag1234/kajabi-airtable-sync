...
export const CURSOS = [
  ...
  { key: 'directo-express', nombre: 'Directo al Aptis Express', meses: 6, ofertasKajabi: ['Directo al Aptis Express', 'Directos al Aptis Express'], renovaciones: RENOVACIONES_DIRECTO },
  { key: 'directo-express-tutorizado', nombre: 'Directo al Aptis Express Tutorizado', meses: 6, ofertasKajabi: ['Directo al Aptis Express Tutorizado'], renovaciones: RENOVACIONES_DIRECTO },
  { key: 'directo', nombre: 'Directo al Aptis', meses: 12, ofertasKajabi: ['Directo al Aptis', 'Directos al Aptis', 'Aptis Expert'], renovaciones: RENOVACIONES_DIRECTO },
  { key: 'directo-tutorizado', nombre: 'Directo al Aptis Tutorizado', meses: 12, ofertasKajabi: ['Directo al Aptis Tutorizado', 'Aptis Expert Tutorizado'], renovaciones: RENOVACIONES_DIRECTO },
  { key: 'accelerator', nombre: 'Aptis Accelerator', meses: 4, ofertasKajabi: ['Aptis Accelerator', 'Accelerator Lite', 'Accelerator Plus'], renovaciones: RENOVACIONES_ACCELERATOR },
  { key: 'level', nombre: 'Aptis Level', meses: 3, ofertasKajabi: ['Aptis Level', 'Aptis Level - Policía Nacional', 'Aptis Level - Policia Nacional'], renovaciones: RENOVACIONES_LEVEL },
  { key: 'level-express', nombre: 'Aptis Level Express', dias: 50, ofertasKajabi: ['Aptis Level Express'], renovaciones: RENOVACIONES_LEVEL },
  ...
  { key: 'ten-tu-aptis-4m', nombre: 'Ten tu Aptis (4 meses)', meses: 4, ofertasKajabi: ['Ten tu Aptis 4 meses', 'Ten tu Aptis 4', 'Ten tu Aptis'], renovaciones: [] },
  { key: 'ten-tu-aptis-8m', nombre: 'Ten tu Aptis (8 meses)', meses: 8, ofertasKajabi: ['Ten tu Aptis 8 meses', 'Ten tu Aptis 8'], renovaciones: [] },
];
